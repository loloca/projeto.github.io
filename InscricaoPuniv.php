          ...
          <div class="row">
            <div class="col-md-12">
              <div class="col-12 col-md-12">
                <h5 class="text-white mt-5"> PAINEL DE INSCRIÇÃO PARA OS CURSOS PRÉ-UNIVERSITÁRIO »PUNIV» </h5>
                    ...
                    <div class="col-md-9">
                        ...
                        <form class="row gx-3 gy-2 align-items-left mt-3 needs-validation" novalidate>
                            ...
                            <div class="col-md-6">
                                ...
                                <option selected disabled value="">Selecione...</option>
                                <option value="Ciência Económicas e Jurídicas">Ciência Económicas e Jurídicas</option>
                                <option value="Ciências Físicas e Biólogicas">Ciências Físicas e Biólogicas</option>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="card bg-white">
                           ...
                           <strong>Cursos</strong><br>
                            1º Físicas & Biológicas <br>
                            2º Económicas & Jurídicas <br>
