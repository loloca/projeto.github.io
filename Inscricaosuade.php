          ...
          <div class="row">
            <div class="col-md-12">
              <div class="col-12 col-md-12">
                <h5 class="text-white mt-5"> PAINEL DE INSCRIÇÃO PARA OS CURSOS DA ARE DE SAÚDE </h5>
                    ...
                    <div class="col-md-9">
                        ...
                        <form class="row gx-3 gy-2 align-items-left mt-3 needs-validation" novalidate>
                            ...
                            <div class="col-md-6">
                                ...
                                <option selected disabled value="">Selecione...</option>
                                <option value="Analíses Clínicas">Analíses Clínicas</option>
